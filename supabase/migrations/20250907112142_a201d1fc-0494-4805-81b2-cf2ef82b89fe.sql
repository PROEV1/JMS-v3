-- Create a transaction function to handle offer acceptance atomically
...
BEGIN
  ...
  -- Get current workload for the date
  SELECT get_engineer_daily_workload_with_holds(p_engineer_id, v_offered_date::text)
