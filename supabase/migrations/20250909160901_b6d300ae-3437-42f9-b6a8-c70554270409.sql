-- Fix the get_schedule_status_counts_v2 function with correct enum values
...
BEGIN 
  WITH counts AS (
    SELECT 
      ...
      -- Completion Pending: orders marked as install_completed_pending_qa
      COUNT(*) FILTER (
      ...
      -- On Hold: orders marked as on_hold_parts_docs
      COUNT(*) FILTER (
