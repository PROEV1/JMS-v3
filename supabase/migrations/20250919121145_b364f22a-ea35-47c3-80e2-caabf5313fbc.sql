-- Hard delete chargers except specified SKUs and clear assignment data
...
-- Delete charger change logs for chargers we're removing
DELETE FROM charger_change_log 
WHERE original_charger_id NOT IN (
  SELECT id FROM charger_inventory ci
